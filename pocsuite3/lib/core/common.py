...
def set_paths(root_path):
    ...
    paths.FTP_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_ftp.txt")
    paths.IMAP_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_imap.txt")
    paths.IMAP_SSL_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_imap_ssl.txt")
    paths.MEMCACHED_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_memcached.txt")
    paths.MONGODB_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_mongodb.txt")
    paths.MYSQL_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_mysql.txt")
    paths.ORACLE_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_oracle.txt")
    paths.POP3_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_pop3.txt")
    paths.POSTGRESQL_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_postgresql.txt")
    paths.RDP_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_rdp.txt")
    paths.REDIS_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_redis.txt")
    paths.SMB_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_smb.txt")
    paths.SMTP_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_smtp.txt")
    paths.SQL_SERVER_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_sqlserver.txt")
    paths.SSH_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_ssh.txt")
    paths.SVN_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_svn.txt")
    paths.TELNET_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_telnet.txt")
    paths.TOMCAT_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_tomcat.txt")
    paths.VNC_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_vnc.txt")
    paths.WEBLOGIC_PASS = os.path.join(paths.POCSUITE_DATA_PATH, "dic_password_weblogic.txt")

    paths.FTP_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_ftp.txt")
    paths.IMAP_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_imap.txt")
    paths.IMAP_SSL_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_imap_ssl.txt")
    paths.MEMCACHED_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_memcached.txt")
    paths.MONGODB_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_mongodb.txt")
    paths.MYSQL_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_mysql.txt")
    paths.ORACLE_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_oracle.txt")
    paths.POP3_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_pop3.txt")
    paths.POSTGRESQL_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_postgresql.txt")
    paths.RDP_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_rdp.txt")
    paths.REDIS_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_redis.txt")
    paths.SMB_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_smb.txt")
    paths.SMTP_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_smtp.txt")
    paths.SQL_SERVER_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_sqlserver.txt")
    paths.SSH_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_ssh.txt")
    paths.SVN_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_svn.txt")
    paths.TELNET_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_telnet.txt")
    paths.TOMCAT_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_tomcat.txt")
    paths.VNC_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_vnc.txt")
    paths.WEBLOGIC_USER = os.path.join(paths.POCSUITE_DATA_PATH, "dic_username_weblogic.txt")
